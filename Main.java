import java.util.Scanner; //Step one, import scanner
	...
	public static NetflixOriginal instantiateFromInput(Scanner keyboard)
		{
			...
			do {
				...
				if(!isValid) {
					//System.out.println("ERROR: genre must be one of the allowed/recognized genres: " + NetflixOriginal.VALID_GENRE_STRING + "\n");
				}
			} while(!isValid);
